---
title: Palimpsest — ewolucja założenia
description: Zwierzyniec jako palimpsest architektoniczny – pięć stuleci ewolucji stylistycznej układu villowego, od renesansu po osadę urzędniczą
tags:
  - dziedzictwo
  - villa
  - architektura
...
**Układ villowy wchodzi już w piąte stulecie.** Na pierwotnej kanwie *la villa ideale in modo italiano* — tj. na świadomych założeniach estetycznych — kształtowano kolejne maniery stylowe: renesans francuski, barok włoski, klasycyzm oświecenia i formy projektowe dla rezydencjonalno-urzędniczej osady-ogrodu. Zwierzyniec nigdy nie był posiadłością marginalną, lecz cenioną i stale rozwijaną siedzibą rodową.[^1]

Pojęcie **palimpsestu** — pergaminu, z którego zeskrobano dawny tekst, by napisać nowy, przy czym ślady pierwotnego pisma przeświecają spod nałożonych warstw — opisuje ewolucję Zwierzyńca z niezwykłą trafnością. Każdy kolejny ordynat dodawał nową warstwę, ale żaden nie wymazał renesansowego kodu geometrycznego.

## 1. Model idealnej villi (ok. 1593)
...
2. dwie symetryczne drewniane oficyny
3. zabudowania gospodarcze
4. medianę ogrodu kwaterowego z kopcem widokowym
5. dukt leśny do ogrodów na Bukowej Górze
6. staw *villowy* przed podjazdem
7. budynek wrotnych przed dziedzińcem
8. groblę z drogą dojazdową
9. most — system zastawek
10. *zwierzyńczyk* (teren oswojonej fauny)
...
- **staw z czterema wyspami** — kopany rękami tureckich jeńców podarowanych Zamoyskiemu przez Jana Sobieskiego
- **ermitaż** na środkowej wyspie stawu
- **długi kanał** wzdłuż grobli dojazdowej
- **grobla *Marysieńki*** wedle stawu
...
- **cztery murowane klasycystyczne oficyny** — ustawione w podkowę wokół starej drewnianej willi
- **sentymentalny park** z kanałami wodnymi, mostkami, altanami nad [Wieprzem](/zwierzyncopedia/przyroda/rzeka-wieprz/)
- **młyn z kołem podsiębiernym** — z domkiem młynarza
- **chiński mostek** nad przelewem wody ze stawu
- *złamane* kolumny — romantyczne artefakty ogrodowe

Za tego ordynata rozpoczęto regulację koryta Wieprza — likwidację licznych zakoli rzeki.
...
- *rzymski* sarkofag na wyspie topolowej (jak grobowiec Rousseau w Ermenonville)
- oko *Opatrzności Bożej*
- aleja i lipa *Marysieńki*
- chińskie mostki nad kanałami byłych meandrów Wieprza

Mapa pomiarowa z 1829–1830 r. rejestrowała pełne rozwinięcie założenia: modrzewiową willę w centrum, dwie stare drewniane oficyny, cztery nowe murowane oficyny, ogrody kwaterowe z kopcem widokowym, kanał, groble, stawy — wszystko w czytelnym porządku geometrycznym.

Były to **końcowe lata świetności** starej willi. Ostatni dokument wzmiankujący jej istnienie pochodzi z 20 września 1833 r.
...
- [Willa Zamoyskich](/zwierzyncopedia/dziedzictwo/architektura/willa-zamoyskich/) — centralny budynek założenia
- [Osie widokowe](/zwierzyncopedia/dziedzictwo/uklad-urbanistyczny/osie-widokowe/) — geometria kompozycji *ad quadratum*
- [Mapy i plany](/zwierzyncopedia/biblioteka/mapy-i-plany/) — kartografia dokumentująca kolejne fazy
- [Ordynaci zamojscy](/zwierzyncopedia/ludzie/ordynaci-zamojscy/) — fundatorzy kolejnych warstw

[^1]: L. Matławska-Patyk, M. Patyk, *Villa Restituta w Zwierzyńcu — studium*, Zwierzyniec 2025, rozdz. VII.
[^2]: Tamże, rozdz. III i VII — model idealnej villi.
[^3]: Tamże, rozdz. VII — maniera renesansu francuskiego, III ordynat.
[^4]: Tamże, rozdz. VII — barok włoski, VII ordynat.
[^5]: Tamże, rozdz. VII — maniera sentymentalna, XI ordynat.
[^6]: Tamże, rozdz. VII — ogrody romantycznych i oświeconych, XII ordynat.
[^7]: Tamże, rozdz. VII — osada urzędnicza, XIII ordynat.
[^8]: Tamże, rozdz. IX — ocena i hierarchia wartości.
[^9]: Tamże, rozdz. VIII.4.
