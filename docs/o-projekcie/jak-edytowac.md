...
# Jak edytować hasła Zwierzyńcopedii
...
Na każdej stronie Zwierzyńcopedii znajdziesz ikonę ołówka (:material-pencil:) – kliknięcie przeniesie Cię do edytora plików na GitHub, gdzie możesz zaproponować zmianę (Pull Request).
